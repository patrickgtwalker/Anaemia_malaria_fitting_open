...
vignette: >
  %\VignetteIndexEntry{Inferring Malaria Impact on Hemoglobin from Datasets, Including Those Where Women with Anaemia Are Excluded at Enrollment}
...
print(min(synthetic_data_df$data_df$hb_level))
